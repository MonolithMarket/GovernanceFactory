...
contract StakedGovTokenIntegrationTest is Test, CloneTestUtils {
    ...
    function testDepositDistributesPendingRevenueBeforeMintingStake() public {
        _stake(alice, 100 ether);
        lender.setAccruedLocalReserves(30 ether);

        // A deposit made ahead of a public distribution flushes existing revenue
        // against the old supply before the attacker's stake is minted.
        ...
        (uint256 treasuryAmount, uint256 govStakingAmount) = router.distribute();
